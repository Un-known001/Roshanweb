      ...
      <div className="Container">
        ...
        <ScrollAnimation animateIn="fadeInLeft">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
            Hello! Myself <strong>Roshan Sharma</strong>. I'm from Nepal and have been living in Kathmandu for the past two years. During my time here, I gained valuable experience through various entry-level positions, which greatly enhanced my work ethic, communication skills, and adaptability.
            </ScrollAnimation>
